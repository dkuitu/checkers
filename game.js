class Checkers {
  ...
  updateScoreboard() {
    ...
    movesElement.textContent = `Moves: ${this.moveCounter}`;
    currentPlayerElement.textContent = `Player: ${this.currentPlayer === this.player1 ? 'HUMAN' : 'AI'}`;
    player1CapturesElement.textContent = `Player 1 Captures: ${this.piecesCaptured[this.player1] !== undefined ? this.piecesCaptured[this.player1] : '0'}`;
    player2CapturesElement.textContent = `Player 2 Captures: ${this.piecesCaptured[this.player2] !== undefined ? this.piecesCaptured[this.player2] : '0'}`;
